<div class="content-wrapper px-4 pt-4">
  ...
  <div class="mb-3">
    <a href="<?= site_url('klinik/petugas_verifikasi/create') ?>" class="btn btn-primary">
            ...
            <?php $no = 1; foreach ($petugas as $p): ?>
              <tr>
                ...
                <td class="text-center">
                  <a href="<?= site_url('klinik/petugas_verifikasi/edit/'.$p->id_verifikasi) ?>" class="btn btn-sm btn-warning">
                    <i class="fas fa-edit"></i> Edit
                  </a>
                  <a href="<?= site_url('klinik/petugas_verifikasi/delete/'.$p->id_verifikasi) ?>"
