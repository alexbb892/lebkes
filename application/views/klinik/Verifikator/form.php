<div class="content-wrapper px-4 pt-4">
  <div class="d-flex justify-content-between align-items-center mb-4">
    <h3 class="text-dark fw-bold mb-0">
      <i class="fas <?= isset($petugas->id_petugas) ? 'fa-user-edit' : 'fa-user-plus' ?> me-2 text-primary"></i>
      <?= isset($petugas->id_petugas) ? 'Edit Verifikator' : 'Tambah Verifikator' ?>
    </h3>
    <a href="<?= site_url('klinik/verifikator') ?>" class="btn btn-sm btn-outline-secondary">
      ...
      <div class="card border-0 shadow-sm rounded-3">
        <div class="card-header bg-white border-bottom py-3">
          <h5 class="card-title fw-bold text-secondary mb-0">
            <?= isset($petugas->id_petugas) ? 'Formulir Pembaruan Data' : 'Formulir Pendaftaran Verifikator Baru' ?>
          </h5>
        </div>
        <div class="card-body p-4">
          <form action="<?= $action ?>" method="post">
            ...
            <div class="mb-3">
              <label for="nama_petugas" class="form-label fw-semibold text-muted small mb-1">NAMA VERIFIKATOR <span class="text-danger">*</span></label>
              <div class="input-group">
                ...
                <input type="text" id="nama_petugas" name="nama_petugas" class="form-control border-start-0"
                       ...
                       placeholder="Masukkan nama lengkap verifikator..." required>
              </div>
            </div>
            ...
            <div class="d-flex justify-content-between align-items-center pt-2">
              <a href="<?= site_url('klinik/verifikator') ?>" class="btn btn-light border px-4">
