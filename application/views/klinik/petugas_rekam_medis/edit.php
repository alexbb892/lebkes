<div class="content-wrapper px-4 pt-4">
  <div class="d-flex justify-content-between align-items-center mb-4">
    <h3 class="text-dark fw-bold mb-0">
      <i class="fas fa-user-edit me-2 text-primary"></i> EDIT DATA DOKTER PEMERIKSA
    </h3>
      ...
      <div class="card border-0 shadow-sm rounded-3">
        <div class="card-header bg-white border-bottom py-3">
          <h5 class="card-title fw-bold text-secondary mb-0">
            Formulir Pembaruan Data Dokter
          </h5>
        </div>
        <div class="card-body p-4">
          <form action="<?= site_url('klinik/petugas_dokter/update/' . $dokter->id_dokter) ?>" method="post">
            ...
            <div class="mb-3">
              ...
              <div class="input-group">
                ...
                <input type="text" id="nama_dokter" name="nama_dokter" class="form-control border-start-0" 
                       value="<?= htmlspecialchars($dokter->nama_dokter) ?>" placeholder="Masukkan nama lengkap dokter..." required>
              </div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="input-group">
                ...
                <input type="text" id="spesialisasi" name="spesialisasi" class="form-control border-start-0" 
                       value="<?= htmlspecialchars($dokter->spesialisasi) ?>" placeholder="Masukkan spesialisasi (misal: Umum, Anak)..." required>
              </div>
            </div>
            ...
            <div class="mb-4">
              ...
              <div class="input-group">
                ...
                <input type="text" id="sip" name="sip" class="form-control border-start-0" 
                       value="<?= htmlspecialchars($dokter->sip) ?>" placeholder="Masukkan nomor Surat Izin Praktik (SIP)..." required>
              </div>
            </div>
